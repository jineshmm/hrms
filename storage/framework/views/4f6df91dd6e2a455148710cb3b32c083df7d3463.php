        ...
        <div class="row">
                    ...
                    <div class="panel-body">
                        <div class="row pv10">
                            <div class="col-xs-5 ph10">
                                <img src="<?php echo e(URL::asset('assets/img/pages/clipart2.png')); ?>" class="img-responsive mauto" alt=""/></div>
                            <div class="col-xs-7 pl5">
                                <h3 class="text-muted"><a href="<?php echo e(route('employee-manager')); ?>"> EMPLOYEE MANAGER</a></h3>
                                <?php /*<h2 class="fs50 mt5 mbn">385</h2>*/ ?>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="panel panel-tile">
                    <div class="panel-body">
                        <div class="row pv10">
                            <div class="col-xs-5 ph10"><img src="<?php echo e(URL::asset('assets/img/pages/clipart0.png')); ?>"
...
<!--                <div class="col-sm-6 col-xl-3">
                    <div class="panel panel-tile">
                        <div class="panel-body">
                            <div class="row pv10">
                                <div class="col-xs-5 ph10"><img src="<?php echo e(URL::asset('assets/img/pages/Laptop Sketch-64x64')); ?>"
...
<!--                <div class="col-sm-6 col-xl-3">
                    <div class="panel panel-tile">
                        <div class="panel-body">
                            <div class="row pv10">
                                <div class="col-xs-5 ph10"><img src="<?php echo e(URL::asset('assets/img/pages/dollar.jpg')); ?>"
                                                                class="img-responsive mauto" style="height: 100px; width: 100px;" alt=""/></div>
                                <div class="col-xs-7 pl5">
...
<!--            <div class="col-sm-6 col-xl-3">
                <div class="panel panel-tile">
                    <div class="panel-body">
                        <div class="row pv10">
                            <div class="col-xs-5 ph10"><img src="<?php echo e(URL::asset('assets/img/pages/clipart5.png')); ?>"
                                                            class="img-responsive mauto" alt=""/></div>
                            <div class="col-xs-7 pl5">
...
<!--            <div class="col-sm-6 col-xl-3">
                <div class="panel panel-tile">
                    <div class="panel-body">
                        <div class="row pv10">
                            <div class="col-xs-5 ph10"><img src="<?php echo e(URL::asset('assets/img/pages/clipart6.png')); ?>"
                                                            class="img-responsive mauto" alt=""/></div>
                            <div class="col-xs-7 pl5">
...
<!--                <div class="col-md-12">
                    ...
                    <?php foreach(array_chunk($meetings, 3, true) as $results): ?>
                        <table class="table">
                            <tr>
                                <?php foreach($results as $meeting): ?>
                                    <td>
                                        <div class='fc-event fc-event-primary' data-event="primary">
                                            <div class="fc-event-icon" style="color: darkslateblue">
                                                <span class="fa fa-exclamation"></span>
