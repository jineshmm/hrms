                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label class="field select">
                                        <?php echo Form::select('column', getTotalLeaveColumns(),$column); ?>
                                ...
                                <table class="table allcp-form theme-warning tc-checkbox-1 fs13">
                                    ...
                                    <?php foreach($leaves as $leave): ?>
                                        <tr>
                                            ...
                                            <td class="text-center"> <?php echo e($leave->totalLeaves); ?> </td>
                                            <td class="text-center"> <?php echo e(23-$leave->totalLeaves); ?> </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    <tr>
                                        <td colspan="6">
