                            ...
                            <div class="box-body no-padding">
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <td><strong>Name</strong><input type="hidden" value="<?php echo csrf_token(); ?>" id="token"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($leave->user->employee->code); ?></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 10px" class="text-center">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e((isset($leave->exit_reentry_flag) && $leave->exit_reentry_flag ==1) ? 'Yes' : 'N/A'); ?></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 10px" class="text-center">
                                        </td>
                                        <td><strong>Flight ticket</strong></td>
                                        <td><?php echo e((isset($leave->flight_ticket_flag) && $leave->flight_ticket_flag ==1) ? 'Yes' : 'N/A'); ?></td>
                                    </tr>
                                    <?php if($leave->flight_ticket_flag ==1): ?>
                                    <tr>
                                        <td style="width: 10px" class="text-center">
                                        </td>
                                        <td><strong>Self</strong></td>
                                        <td><?php echo e(( $leave->self_ticket >0) ? $leave->self_ticket : 1); ?></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 10px" class="text-center">
                                        </td>
                                        <td><strong>Spouse ticket count</strong></td>
                                        <td><?php echo e(( $leave->spouse_ticket >0) ? $leave->spouse_ticket : 0); ?></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 10px" class="text-center">
                                        </td>
                                        <td><strong>Children ticket count</strong></td>
                                        <td><?php echo e(($leave->children_ticket >0)? $leave->children_ticket : 0); ?></td>
                                    </tr>
                                    <?php endif; ?>
                                    <tr>
                                        <td style="width: 10px" class="text-center">
