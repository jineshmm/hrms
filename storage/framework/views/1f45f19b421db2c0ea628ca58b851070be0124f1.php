    ...
    <div class="media">
        <a href="/profile" class="media-left">
            <?php if(Auth::user()->employee->photo): ?>
                <img src="/photos/<?php echo e(Auth::user()->employee->photo); ?>" width="40px" height="30px" class="img-responsive">
            <?php else: ?>
...
<ul class="nav sidebar-menu scrollable">
    <li class="active">
        <a  href="/overview/employee/<?php echo e(Auth::user()->id); ?>">
    ...
    <?php if(Auth::user()->isHR()): ?>
        <li>
            ...
            <ul class="nav sub-nav">
                ...
                <li>
                    <a href="<?php echo e(route('employee-file-details',\Auth::user()->employee->id)); ?>">
                        <span class="glyphicon glyphicon-tags"></span> Uploaded files </a>
                </li>
...
<!--        <li>
        ...
        <a class="accordion-toggle" href="/dashboard">
            ...
            <span class="sidebar-title">Loans</span>
            <span class="caret"></span>
        </a>
        <ul class="nav sub-nav">
            <li>
                <a href="<?php echo e(route('apply-loan')); ?>">
                    <span class="glyphicon glyphicon-shopping-cart"></span> Apply Loan </a>
            </li>
            <li>
                <a href="<?php echo e(route('my-loan-list')); ?>">
                    <span class="glyphicon glyphicon-calendar"></span> My Loan List </a>
            </li> 

            <?php if(Auth::user()->isHR() || Auth::user()->isCoordinator()): ?>
                <li>
                    <a href="<?php echo e(route('total-loan-list')); ?>">
                        <span class="fa fa-clipboard"></span> Total Loan Listings </a>
                </li>
            <?php endif; ?>
...
<!--        <li>
    ...
    <li>
     ...
     <?php if(Auth::user()->isFinanceManager() || Auth::user()->isHR()): ?>    
        
        <li>
            <a class="accordion-toggle" href="/dashboard">
                <span class="fa fa-arrow-circle-o-up"></span>
                <span class="sidebar-title">Travel expenses</span>
                <span class="caret"></span>
            </a>
            <ul class="nav sub-nav">
                <li>
                    <a href="/travel-expense">
                        <span class="glyphicon glyphicon-book"></span>Tickets </a>
                </li>
                <li>
                    <a href="/exit-entry-list">
                        <span class="glyphicon glyphicon-modal-window"></span> Exit re-entry </a>
                </li>
            </ul>
        </li>
...
<li>
        ...
        <?php if( \Auth::user()->isHR() ): ?>
          <li>
            <a href="/payroll-list">
                <span class="fa fa-calendar-o"></span>
                <span class="sidebar-title"> Generate payroll </span>
            </a>
        </li>  
        ...
        <li>
                ...
                <ul class="nav sub-nav">
                   <li>
                        <a href="<?php echo e(route('vocation-balance')); ?>">
                            <span class="glyphicon glyphicon-tags"></span> Vocation Balances </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('termination-report')); ?>">
                            <span class="glyphicon glyphicon-tags"></span>Employee termination report</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('loan-report')); ?>">
                            <span class="glyphicon glyphicon-tags"></span>Loans statement</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('gosi-report')); ?>">
                            <span class="glyphicon glyphicon-tags"></span>Gosi report</a>
                    </li>
