    ...
    $(document).ready(function() {
        ...
        form.children(".wizard").steps({
            ...
            onStepChanging: function(event, currentIndex, newIndex) {
                form.validate().settings.ignore = ":disabled,:hidden,.hidden-field";
                return form.valid();
            },
            onFinishing: function(event, currentIndex) {
                form.validate().settings.ignore = ":disabled,.hidden-field";
                return form.valid();
            },
            onFinished: function(event, currentIndex) {
                //event.preventDefault();
                
                $("#custom-form-wizard").submit();
...
//                //New columns
//                
//                var direct_manager = $('#direct_manager').val();
//                var housing_allowance = $('#housing_allowance').val();
//                var transport_allowance = $('#transportation_allowance').val();
//                var employee_type = $('#employee_type').val();
//                var employee_gosi = $('#employee_gosi').val();
//                var employer_gosi = $('#employer_gosi').val();
//                
//                
//                
//
...
//                
//                formData.append('direct_manager', direct_manager);
//                formData.append('housing_allowance', housing_allowance);
//                formData.append('transportation_allowance', transport_allowance);
//                formData.append('employee_type', employee_type);
//                formData.append('employee_gosi', employee_gosi);
//                formData.append('employer_gosi', employer_gosi);
//                
//                 formData.append('emp_last_name', $('#emp_last_name').val());
//                  formData.append('emp_name_ar', $('#emp_name_ar').val());
//                   formData.append('emp_last_name_ar', $('#emp_last_name_ar').val());
//                    formData.append('emp_national_id', $('#emp_national_id').val());
//                     formData.append('emp_nationality', $('#emp_nationality').val());
//                      formData.append('emp_other_allowance', $('#emp_other_allowance').val());
//                      formData.append('emp_grade', $('#emp_grade').val());
//                formData.append('emp_email', $('#emp_email').val());
//                
