                        ...
                        <div class="panel-body pn">
                            ...
                            <div class="table-responsive">
                                <table class="table allcp-form theme-warning tc-checkbox-1 fs13">
                                    ...
                                    @foreach($emps as $emp)
                                    <tr>
                                        <td class="text-center"><a href="/overview/employee/{{$emp->id}}">{{$i+=1}}</a></td>
                                        <td class="text-center">  {{ isset($emp->employee->code)?$emp->employee->code:'' }}</td>
                                        ...
                                        <td class="text-center">{{ isset($emp->employee->date_of_joining)? date('Y-m-d', strtotime($emp->employee->date_of_joining)):''    }}</td>
                                        <td class="text-center">{{  isset($emp->employee->current_address)? $emp->employee->current_address:'' }}</td>
                                        <td class="text-center">{{isset($emp->employee->number)? $emp->employee->number:''}}</td>
                                        <td class="text-center">{{isset($emp->employee->department->title)? $emp->employee->department->title:'' }}</td>
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li>
                                                     ...
                                                     <li>
                                                        <a href="/upload-emp-files/{{$emp->id}}">Upload files</a>
                                                    </li>
                                                    <li>
                                                        <a href="/list-emp-files/{{$emp->employee['id']}}">View documents</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
