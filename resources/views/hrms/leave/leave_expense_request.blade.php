...
<div class="content">
                                ...
                                <div class="table-responsive">
                                    <table class="table allcp-form theme-warning tc-checkbox-1 fs13">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-center"><a href="/travel-details/{{$leave->employeeId}}">{{$i+=1}}</a></td>
                                                ...
                                                <td class="text-center" id="remark-{{$leave->expId}}">{{$leave->remarks}}</td>
                                                <td class="text-center">@if(isset($leave->ticket_file))
                                                    <a href="/downloadleavedocuments/{{$leave->leaveId}}/1">{{$leave->ticket_file}}</a>
                                                    @endif
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group text-right" id="button-{{$leave->expId}}">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" >
                                                            <li>
                                                                <a class="approveexpenseClick" data-id="{{$leave->expId}}" data-leaveid="{{$leave->leaveId}}" data-empid='{{$leave->applieduser}}'  data-self='{{$leave->self_ticket}}' data-spouse='{{$leave->spouse_ticket}}' data-child="{{$leave->children_ticket}}" data-name="approve" >Approve</a>
                                                            </li>
                                                            <li>
                                                                <a class="disapproveexpenseClick" data-id="{{$leave->expId}}" data-name="disapprove" >Disapprove</a>
                                                            </li>
                                                        </ul>
                                                        @elseif($leave->approved_status==1)
                                                        <button type="button"
    ...
    <div id="closeModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                {{ Form::open(array('route' => array('approve-expense'), 'class' => 'form-horizontal','id'=>'form_request-close','files'=>'true' )) }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
