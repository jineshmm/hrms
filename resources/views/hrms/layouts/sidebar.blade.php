    ...
    @if(Auth::user()->isHR())
        <li>
            ...
            <ul class="nav sub-nav">
                ...
                <li>
                    <a href="{{route('employee-file-details',\Auth::user()->employee->id)}}">
...
<!--        <li>
    ...
    <li>
     ...
     @if(Auth::user()->isFinanceManager() || Auth::user()->isHR())    
...
<li>
        ...
        <li>
                ...
                <ul class="nav sub-nav">
                   <li>
                        <a href="{{route('vocation-balance')}}">
                            <span class="glyphicon glyphicon-tags"></span> Vocation Balances </a>
                    </li>

                    <li>
                        <a href="{{route('termination-report')}}">
